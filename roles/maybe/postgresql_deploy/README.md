...
```
find . -type f -print0 | xargs -0 sed -i "s/hf_postgresql_deploy/new_role/g"
...
```
find . -type f -print0 | LC_ALL=C  xargs -0  sed -i "" 's/hf_postgresql_deploy/new_role/g'
```
