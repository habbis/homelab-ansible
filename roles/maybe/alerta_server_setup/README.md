...
[![CI](https://github.com/habbis/hf_patching/workflows/CI/badge.svg)](https://github.com/habbis/hf_patching/actions?query=workflow%3ACI)
...
```
find . -type f -print0 | xargs -0 sed -i "s/hf_patching/new_role/g"
...
```
find . -type f -print0 | LC_ALL=C  xargs -0  sed -i "" 's/hf_patching/new_role/g'
```
