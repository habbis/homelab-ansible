...
```
find . -type f -print0 | xargs -0 sed -i "s/hf_haproxy_cloud/new_role/g"
...
```
find . -type f -print0 | LC_ALL=C  xargs -0  sed -i "" 's/hf_haproxy_cloud/new_role/g'
```
